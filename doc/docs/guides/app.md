...
see
[Accessing Data From Other Cells](../formulas.md#accessing-data-from-other-cells-tables-columns).
...
the `List` type, see [Types](../formulas.md#types). You can configure the
...
want to read the [Formulas Manual](../formulas.md) to better understand
...
* Second, we filter all the rows from the _Items_ table according to the
  ...
  the [filter function](../formulas.md#filter) takes two arguments:
...
under [Report Templates](../formulas.md#report-templates). Also, you might want
to learn about [anonymous functions](../formulas.md#anonymous-functions) and
the [included functions](../formulas.md#included-functions) of which we use
some here.
