...
aesonifyValue (Bin (Binary binary)) = toJSON $ mkBase64 binary
aesonifyValue (Fun (Function function)) = toJSON $ mkBase64 function
aesonifyValue (Uuid (UUID uuid)) = toJSON $ mkBase64 uuid
aesonifyValue (Md5 (MD5 md5)) = toJSON $ mkBase64 md5
aesonifyValue (UserDef (UserDefined userdef)) = toJSON $ mkBase64 userdef
